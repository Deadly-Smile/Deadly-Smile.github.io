            ...
            <div className="">
              <div className="animate-custom-bounce custom-bounce w-4/5 block ml-auto mr-auto max-w-sm">
                ...
                <p className="mt-2 text-white">
                  ...
                  <a
                    href="https://www.orbitinformatics.com/"
              ...
              <div className="mt-4 w-3/5 text-center ml-auto mr-auto mb-8">
                <p className="text-slate-50">
                  {`Hello, I'm Anik Saha, a Junior Software Engineer at Orbit Informatics. I'm currently exploring the fascinating world of web development and constantly learning to build better, smarter web experiences.`}
                </p>
                <div className="rounded-full block ml-auto mr-auto w-1/6 my-5">
                ...
                <div className="my-4">
                  ...
                  <div className="rounded-full block ml-auto mr-auto w-1/2 my-6">
                    <ul className="flex justify-between text-4xl">
                      <li
                        className="animate-custom-bounce custom-bounce-small"
                        title="React"
